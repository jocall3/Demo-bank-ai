...
const InvestmentPortfolio: React.FC = () => {
    ...
    // FIX: Recharts can be strict about data types. Creating a new array of plain objects from the context data
    // ensures compatibility and resolves potential "Index signature for type 'string' is missing" errors.
